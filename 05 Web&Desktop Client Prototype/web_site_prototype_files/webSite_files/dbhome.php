...
<body>
    ...
    <div id="wrapper">
        <div id="cont">
        	...
        	<div id="holder">
            	<div id="desc1"> 
                    <form class= "style1" method="post" action="dbhome.php">
             ...
             <div id="holder">  
            	<div id="desc2" class="style5">                
                    <?php
						...
						else $tblName = 'PROPERTIES'; /*change for the table case in new page*/
            ...
            <div id="holder">
				<div id="filter" class="style5"> 
                	 <b class="style1">Filter your search</b>&nbsp; (*) Req. fields<br/>
                    <?php
						bringFormat($tblName);	
					?>                    
                 </div>   
