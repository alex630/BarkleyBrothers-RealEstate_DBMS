...
<body>
    ...
    <div id="wrapper">
        <div id="cont">
        	...
        	<div id="holder">
            	<div id="desc1"> 
                    <form class= "style1" method="post" action="branches.php">
             ...
             <div id="holder">  
            	<div id="desc2" class="style5">                
                    <?php
						...
						else $tblName = 'BRANCH_OFFICES'; /*change for the table case*/
